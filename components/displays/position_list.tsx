  ...
  export function PositionRow(
    ...
    return (
      ...
      <div className="p-4 appearance-none grid grid-cols-subgrid col-span-2 gap-3 border-b">
        <Link href={getStockPagePath(stock.id)} className="text-2xl font-bold col-span-1 hover:underline-offset-4 transition-all no-underline underline-offset-[-4ppx] hover:underline decoration-accent-foreground">{stock.symbol}</Link>
